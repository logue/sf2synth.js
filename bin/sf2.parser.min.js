...
function y(g){var e=g.length+g.offset;for(g.a=[];g.b<e;){var b=g,a=b.f,c=b.b;b.a.push(new v(String.fromCharCode(a[c++],a[c++],a[c++],a[c++]),a=b.j?(a[c++]<<24|a[c++]<<16|a[c++]<<8|a[c++])>>>0:(a[c++]|a[c++]<<8|a[c++]<<16|a[c++]<<24)>>>0,c));c+=a;b.g&&1===(c-b.offset&1)&&c++;b.b=c}}function z(g,e){var b=g.a[e];return void 0===b?null:b};function A(g,e){e=e||{};this.a=g;this.g=e.parserOption}
...
2*n,this.b.offset+2*w))).buffer);r-=n;t-=n;if(0<p){var F=p,u,q,G,x;for(e=1;22050>F;){u=new Int16Array(2*g.length);q=x=0;for(G=g.length;q<G;++q)u[x++]=g[q],u[x++]=g[q];g=u;e*=2;F*=2}p*=e;r*=e;t*=e}c.push(g);d.push({L:h,start:n,end:w,N:r,m:t,sampleRate:p,C:B,D:C,K:D,M:E})}this.a=null};
