 ...
 * @param {number} depth 
 */
SoundFont.Synthesizer.prototype.reverbDepth = function (channel, depth) {
...
SoundFont.Synthesizer.prototype.updateBankSelect = function (channel) {
  if (!this.element) {
    //    return;
  }
...
SoundFont.Synthesizer.prototype.updateProgramSelect = function (channel) {
  if (!this.element) {
    //    return;
  }
  /** @type {number} */
 ...
 * @param {number} instrument 音色番号.
 */
SoundFont.Synthesizer.prototype.bankChange = function (channel, bank) {
 ...
 */
SoundFont.Synthesizer.prototype.attackTime = function (channel, attackTime) {
 ...
 */
SoundFont.Synthesizer.prototype.decayTime = function (channel, decayTime) {
 ...
 */
SoundFont.Synthesizer.prototype.sustinTime = function (channel, sustinTime) {
 ...
 * @param {number} value
 */
SoundFont.Synthesizer.prototype.harmonicContent = function (channel, value) {
 ...
 * @param {number} value
 */
SoundFont.Synthesizer.prototype.cutOffFrequency = function (channel, value) {
